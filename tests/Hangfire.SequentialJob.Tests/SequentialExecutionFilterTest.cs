...
public class SequentialExecutionFilterTest
{
    private readonly SequentialExecutionFilter _target = new("my-sequence-id");
    ...
    public void Constructor_SequenceIdIsNull_Throws()
    {
        ...
        // Act
        var action = () => new SequentialExecutionFilter(null!);
    ...
    public void Constructor_SequenceIdEmptyOrWhitespaces_Throws(string sequenceId)
    {
        ...
        // Act
        var action = () => new SequentialExecutionFilter(sequenceId);
    ...
    {
        // Arrange
        var target = new SequentialExecutionFilter("id");
    ...
    [Fact]
    public void DistributedLockName_Created_ShouldReturnADescriptiveEnoughDefaultValue()
    {
        // Arrange
        ...
        // Assert
        distributedLockName.Should().ContainAll("Sequential", "Lock");
    }

    [Fact]
    public void SequenceIdParameterName_Created_ShouldReturnADescriptiveEnoughDefaultValue()
    {
        // Arrange
        ...
        // Assert
        sequenceIdParameterName.Should().ContainAll("SequenceId");
    }

    [Fact]
    public void LastJobIdHashName_Created_ShouldReturnADescriptiveEnoughDefaultValue()
    {
        // Arrange
        ...
        // Assert
        sequentialExecutionLastId.Should().ContainAll("Sequential", "Id");
    }
    ...
    public void OnStateElection_CandidateStateIsEnqueued_VerifiesWhetherTheJobHasAlreadyBeenProcessed()
    {
        ...
        // Act
        _target.OnStateElection(context);
    ...
    private static IState CreateState(Type stateType)
    {
        ...
        if (stateType == typeof(ProcessingState))
            return (ProcessingState)Activator.CreateInstance(typeof(ProcessingState), BindingFlags.Instance | BindingFlags.NonPublic, null, new object[] { "the-serverId", "the-workerId" }, null)!;
